...
router.get('/categories', getCategoriesFromJsonServer)
...
router.post('/categories', insertCategoryFromJsonServer)
...
router.delete('/categories/:id', deleteCategoryFromJsonServer)
...
router.get('/categories/:id', getCategoryFromJsonServer)
